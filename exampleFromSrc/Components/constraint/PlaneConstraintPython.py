"""
PlaneConstraintPython
is based on the scene 
/Users/marco.magliulo/mySofaCodes/exampleFromSrc/Components/constraint/PlaneConstraint.scn
...
runSofa /Users/marco.magliulo/mySofaCodes/exampleFromSrc/Components/constraint/PlaneConstraintPython.py --argv 123
...
class PlaneConstraint (Sofa.PythonScriptController):
    ...
    def createGraph(self,rootNode):
        ...
        Liver.createObject('PlaneConstraint', plane='-4 3 0 1 2 1 0 0 1 2')
...
def createScene(rootNode):
    ...
    myPlaneConstraint = PlaneConstraint(rootNode,commandLineArguments)
    return 0;