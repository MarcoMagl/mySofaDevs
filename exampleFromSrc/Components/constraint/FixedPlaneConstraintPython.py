"""
FixedPlaneConstraintPython
is based on the scene 
/Users/marco.magliulo/mySofaCodes/exampleFromSrc/Components/constraint/FixedPlaneConstraint.scn
...
runSofa /Users/marco.magliulo/mySofaCodes/exampleFromSrc/Components/constraint/FixedPlaneConstraintPython.py --argv 123
...
class FixedPlaneConstraint (Sofa.PythonScriptController):
    ...
    def createGraph(self,rootNode):
        ...
        Liver.createObject('FixedPlaneConstraint', direction='0 0 1', dmin='-3', dmax='1')
        Liver.createObject('BoxConstraint', box='-5 4.8 -.2 5 6 1')
...
def createScene(rootNode):
    ...
    myFixedPlaneConstraint = FixedPlaneConstraint(rootNode,commandLineArguments)
    return 0;