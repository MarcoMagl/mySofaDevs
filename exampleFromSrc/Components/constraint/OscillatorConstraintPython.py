"""
OscillatorConstraintPython
is based on the scene 
/Users/marco.magliulo/mySofaCodes/exampleFromSrc/Components/constraint/OscillatorConstraint.scn
...
runSofa /Users/marco.magliulo/mySofaCodes/exampleFromSrc/Components/constraint/OscillatorConstraintPython.py --argv 123
...
class OscillatorConstraint (Sofa.PythonScriptController):
    ...
    def createGraph(self,rootNode):
        ...
        Liver.createObject('EulerImplicitSolver', printLog='false', rayleighStiffness='0.1', name='cg_odesolver', rayleighMass='0.1')
        Liver.createObject('CGLinearSolver', threshold='1.0e-9', tolerance='1.0e-9', name='linear solver', iterations='25')
        Liver.createObject('MechanicalObject', name='dofs')
        Liver.createObject('MeshGmshLoader', name='meshLoader0', filename='mesh/liver.msh')
        Liver.createObject('TetrahedronSetTopologyContainer', src='@meshLoader0', name='topo')
        Liver.createObject('TetrahedronSetGeometryAlgorithms', name='GeomAlgo')
        Liver.createObject('DiagonalMass', massDensity='1', name='computed using mass density')
        Liver.createObject('TetrahedralCorotationalFEMForceField', poissonRatio='0.3', youngModulus='3000', method='large', computeGlobalMatrix='false', name='FEM')
        Liver.createObject('FixedConstraint', indices='3 39 64', name='FixedConstraint')
        Liver.createObject('OscillatorConstraint', oscillators='15 2 0 0 1 0 0 5 10', name='OscillatingConstraint')
...
def createScene(rootNode):
    ...
    myOscillatorConstraint = OscillatorConstraint(rootNode,commandLineArguments)
    return 0;