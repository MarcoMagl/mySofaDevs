"""
FixedConstraintPython
is based on the scene 
/Users/marco.magliulo/mySofaCodes/exampleFromSrc/Components/constraint/FixedConstraint.scn
...
runSofa /Users/marco.magliulo/mySofaCodes/exampleFromSrc/Components/constraint/FixedConstraintPython.py --argv 123
...
class FixedConstraint (Sofa.PythonScriptController):
    ...
    def createGraph(self,rootNode):
        ...
        Liver.createObject('MechanicalObject', src='@loader', name='dofs')
...
def createScene(rootNode):
    ...
    myFixedConstraint = FixedConstraint(rootNode,commandLineArguments)
    return 0;