"""
DistanceLMContactConstraintPython
is based on the scene 
/Users/marco.magliulo/mySofaCodes/exampleFromSrc/Components/constraint/DistanceLMContactConstraint.scn
...
runSofa /Users/marco.magliulo/mySofaCodes/exampleFromSrc/Components/constraint/DistanceLMContactConstraintPython.py --argv 123
...
class DistanceLMContactConstraint (Sofa.PythonScriptController):
    ...
    def createGraph(self,rootNode):
        ...
        cubeFEM.createObject('EulerImplicitSolver', printLog='0', rayleighStiffness='0.1', name='cg_odesolver', rayleighMass='0.1')
        cubeFEM.createObject('CGLinearSolver', threshold='1e-09', tolerance='1e-09', name='linear solver', iterations='25', template='GraphScattered')
        cubeFEM.createObject('LMConstraintSolver', constraintPos='1', numIterations='27', maxError='1e-7', constraintVel='1', name='default0', listening='1')
        cubeFEM.createObject('MechanicalObject', restScale='1', translation='0 2 0', rotation='30 20 15', template='Vec3d', name='dof')
        ...
        Surf.createObject('MeshObjLoader', name='meshLoader', filename='mesh/smCube125.obj')
        Surf.createObject('MeshTopology', src='@meshLoader')
        Surf.createObject('MechanicalObject', scale3d='@../dof.scale3d', rotation='@../dof.rotation', name='default6', template='Vec3d', translation='@../dof.translation', restScale='1')
        ...
        Floor.createObject('MeshObjLoader', name='meshLoader', filename='mesh/floor3.obj')
        Floor.createObject('MeshTopology', src='@meshLoader')
        Floor.createObject('MechanicalObject', scale3d='1.75 1.75 1.75', translation='0 -10 0', name='default12', template='Vec3d', restScale='1')
...
def createScene(rootNode):
    ...
    myDistanceLMContactConstraint = DistanceLMContactConstraint(rootNode,commandLineArguments)
    return 0;