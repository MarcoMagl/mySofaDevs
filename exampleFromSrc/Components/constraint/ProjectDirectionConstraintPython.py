"""
ProjectDirectionConstraintPython
is based on the scene 
/Users/marco.magliulo/mySofaCodes/exampleFromSrc/Components/constraint/ProjectDirectionConstraint.scn
...
runSofa /Users/marco.magliulo/mySofaCodes/exampleFromSrc/Components/constraint/ProjectDirectionConstraintPython.py --argv 123
...
class ProjectDirectionConstraint (Sofa.PythonScriptController):
    ...
    def createGraph(self,rootNode):
        ...
        Square.createObject('BoxROI', box='-0.05 -0.05 -0.05    0.05 1.05 0.05', drawBoxes='1', name='ProjectDirection')
        Square.createObject('ProjectDirectionConstraint', indices='@[-1].indices', drawSize='0.03', direction='0.5 0.5 0')
...
def createScene(rootNode):
    ...
    myProjectDirectionConstraint = ProjectDirectionConstraint(rootNode,commandLineArguments)
    return 0;