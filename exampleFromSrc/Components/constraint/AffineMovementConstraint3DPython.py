"""
AffineMovementConstraint3DPython
is based on the scene 
/Users/marco.magliulo/mySofaCodes/exampleFromSrc/Components/constraint/AffineMovementConstraint3D.scn
...
runSofa /Users/marco.magliulo/mySofaCodes/exampleFromSrc/Components/constraint/AffineMovementConstraint3DPython.py --argv 123
...
class AffineMovementConstraint3D (Sofa.PythonScriptController):
    ...
    def createGraph(self,rootNode):
        ...
        Square.createObject('AffineMovementConstraint', rotation='[1 0 0,0 1 0,1 0 1]', name='bilinearConstraint', template='Vec3d', indices='@PairBox.indices', translation='0.1 0.1 0.1', meshIndices='@Box.indices')
...
def createScene(rootNode):
    ...
    myAffineMovementConstraint3D = AffineMovementConstraint3D(rootNode,commandLineArguments)
    return 0;