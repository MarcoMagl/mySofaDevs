"""
ProjectToPointConstraintPython
is based on the scene 
/Users/marco.magliulo/mySofaCodes/exampleFromSrc/Components/constraint/ProjectToPointConstraint.scn
...
runSofa /Users/marco.magliulo/mySofaCodes/exampleFromSrc/Components/constraint/ProjectToPointConstraintPython.py --argv 123
...
class ProjectToPointConstraint (Sofa.PythonScriptController):
    ...
    def createGraph(self,rootNode):
        ...
        Square.createObject('BoxROI', box='-0.05 -0.05 -0.05    0.05 1.05 0.05', drawBoxes='1', name='ProjectToPlane')
        Square.createObject('ProjectToPointConstraint', indices='@[-1].indices', drawSize='0.03', point='0 0 0')
...
def createScene(rootNode):
    ...
    myProjectToPointConstraint = ProjectToPointConstraint(rootNode,commandLineArguments)
    return 0;