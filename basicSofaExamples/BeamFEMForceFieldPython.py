...
/Users/marco.magliulo/mySofaCodes/basicSofaExamples/BeamFEMForceField.scn
...
runSofa /Users/marco.magliulo/mySofaCodes/basicSofaExamples/BeamFEMForceFieldPython.py --argv 123
...
class BeamFEMForceField (Sofa.PythonScriptController):
    ...
    def createGraph(self,rootNode):
        ...
        beam.createObject('MechanicalObject', position='0 0 0 0 0 -0.7071067811865475244 0.7071067811865475244  0 -1 0 0 0 -0.7071067811865475244 0.7071067811865475244', name='DOFs', template='Rigid3d')
        beam.createObject('MeshTopology', lines='0 1', name='lines')
        ...
        beam2.createObject('MechanicalObject', position='0 0 1 0 0 0 1  1 0 1 0 0 0 1', name='DOFs', template='Rigid3d')
        beam2.createObject('MeshTopology', lines='0 1', name='lines')
