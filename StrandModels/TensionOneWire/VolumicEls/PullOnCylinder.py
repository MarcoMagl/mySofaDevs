...
class ClampedBeam (Sofa.PythonScriptController):
    ...
    def createGraph(self,rootNode):
        ...
        if BC == "Neuman":
            Beam.createObject('ConstantForceField', indices='@NeumanROI.indices', showArrowSize='0.0000', printLog='0', totalForce=[0, 0, forceApplied], topology="@Topo")
        elif BC == "Dirichlet":
            disp = - 2 * UL
            keyTimes = np.zeros(3)
            keyTimes[0] = 0 
        ...
        if fancyMaterialLaw:
            ...
            Beam.createObject(
                ...
                showStressColorMap="red  1 0 0 1  1 0.5 0.5 1",
